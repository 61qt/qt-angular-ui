...
.provider('$page', function () {
  ...
  this.$get = ($q, $location, $filter, IGNORE_QUERY_KEYWORDS) => {
    'ngInject';
          ...
          Page.wechat((sdk) => {
            sdk.ready(() => {
              const WECHAT_SETTING = {
                ...
                imgUrl  : $filter('qiniuImage')(setting.shareBanner || setting.logo),
                link    : setting.shareLink || document.location.href || '',
              };

              let uri    = angular.parseUrl(WECHAT_SETTING.link);
