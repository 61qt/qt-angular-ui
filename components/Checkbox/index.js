...
var Name = exports.Name = 'QtNgUi.Checkbox';
...
if (!(0, _module.exists)(Name)) {
  ...
  var Checkbox = ['$rootScope', function ($rootScope) {
    return {
      restrict: 'EA',
      transclude: true,
      replace: true,
      ...
      link: function link($scope, $element, $attrs, ctrls) {
        ...
        $scope.checked = (0, _isBoolean2.default)($scope.model) ? $scope.model : $attrs.hasOwnProperty('checked');
